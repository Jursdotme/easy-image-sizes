...
class Easy_Image_Sizes_Core
{
    ...
    public function fieldsForEasyImageSizes($post)
    {
        ...
        <div class="easy_image_sizes_item">
            <label for="easy_image_sizes_bw"><?php _e('B&W', $this->text_domain); ?></label><br>
            <select name="easy_image_sizes_bw" id="easy_image_sizes_bw">
                <option <?php echo ($this->getMetaForEasyImageSizes('easy_image_sizes_bw') === 'No') ? 'selected' : '' ?>>No</option>
                <option <?php echo ($this->getMetaForEasyImageSizes('easy_image_sizes_bw') === 'Yes') ? 'selected' : '' ?>>Yes</option>
            </select>
        </div>
    ...
    function manageEasyImageSizesColumns($column, $post_id)
    {
        ...
        switch ($column) {
            ...
            case 'bw':
                $bw = $this->getMetaForEasyImageSizes('easy_image_sizes_bw', $post_id);
